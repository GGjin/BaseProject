package com.gg.baseproject.view.load;
...
public class LoadDialog {
    ...
    public LoadDialog(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.load_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
     ...
     * @return Current HUD
     */
    public LoadDialog setStyle(Style style) {
        View view = null;
        switch (style) {
     ...
     * @return Current HUD
     */
    public LoadDialog setDimAmount(float dimAmount) {
     ...
     * @return Current HUD
     */
    public LoadDialog setWindowColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public LoadDialog setCornerRadius(float radius) {
     ...
     * @return Current HUD
     */
    public LoadDialog setAnimationSpeed(int scale) {
        mAnimateSpeed = scale;
        return this;
    }
     ...
     * @return Current HUD
     */
    public LoadDialog setLabel(String label) {
        mLabel = label;
        return this;
    }
     ...
     * @return Current HUD
     */
    public LoadDialog setDetailsLabel(String detailsLabel) {
     ...
     * @return Current HUD
     */
    public LoadDialog setMaxProgress(int maxProgress) {
     ...
     * @return Current HUD
     */
    public LoadDialog setCustomView(View view) {
        if (view != null) {
            mProgressDialog.setView(view);
        } else {
     ...
     * @return Current HUD
     */
    public LoadDialog setCancellable(boolean isCancellable) {
     ...
     * @return Current HUD
     */
    public LoadDialog setAutoDismiss(boolean isAutoDismiss) {
