...
object ShareFileUtil {
    ...
    fun getFileUri(context: Context?, @ShareContentType shareContentType: String, file: File?): Uri {
        ...
        if (context == null) {
            ...
            throw RuntimeException ("getFileUri current activity is null.")
        }

        if (file == null || !file.exists()) {
            Log.e(TAG, "getFileUri file is null or not exists.")
            throw RuntimeException("getFileUri file is null or not exists.")
        }

        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            Log.e(TAG, "getFileUri miss WRITE_EXTERNAL_STORAGE permission.")
            throw RuntimeException("getFileUri miss WRITE_EXTERNAL_STORAGE permission.")
        }
